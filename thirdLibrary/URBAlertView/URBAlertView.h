...
typedef NS_ENUM (NSInteger, URBAlertAnimation)
{
...
@property (nonatomic, assign) BOOL shouldHorizontal;
@property (nonatomic, assign) UIInterfaceOrientation horizontalOrientation;
